...
export function RavenLogo({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M16 22.5 Q13 21 11 22 Q13.5 24 16 22.5Z"
        fill="currentColor"
        opacity="0.65"
      />
...
const MODES: { id: Mode; icon: typeof Shuffle; label: string; sub: string }[] = [
  {
    ...
    icon: Shuffle,
    label: 'Quick room',
    sub: 'Random ID · encryption key in URL',
  },
  {
    id: 'custom',
    icon: Key,
    label: 'Named room',
    sub: 'Your name · password required',
  },
  {
    id: 'private',
    icon: Shield,
    label: 'Private room',
    sub: 'Random ID · share URL + password separately',
  },
];
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-semibold"
            style={{
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="w-full max-w-md fade-up">
          ...
          <div className="flex justify-center mb-8">
            <div
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full pulse-accent"
              style={{
          ...
          >
            Chat that <span style={{ color: 'var(--accent)' }}>vanishes</span>
            <br />
            when you leave
          </h1>
          <p
          ...
          >
            Messages are encrypted in your browser with AES-256-GCM and
          ...
          >
            <div className="p-6">
              {/* Name */}
              <div className="mb-5">
                <Label htmlFor="participant-name" style={labelStyle}>
                  Your name
                </Label>
                <Input
                  id="participant-name"
                ...
                <div className="space-y-3 mb-5 fade-up">
                  ...
                  <div>
                    ...
                    <Input
                      id="password-custom"
                      type="password"
                      placeholder="Shared with invitees"
                      value={password}
                      onChange={(e) =>
              ...
              {mode === 'private' && (
                <div className="mb-5 fade-up">
                  ...
                  <Input
                    id="password-private"
                    type="password"
                    placeholder="Share separately from the URL"
                    value={password}
                    onChange={(e) =>
                      setPassword(e.target.value)
                    }
