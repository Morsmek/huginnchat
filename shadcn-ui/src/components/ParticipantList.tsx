...
export default function ParticipantList({ participants, currentUserId }: ParticipantListProps) {
  return (
    <div className="w-64 bg-[#1a1a1a] border-l border-[#333333] flex flex-col">
      <div className="px-4 py-3 border-b border-[#333333]">
        <h3 className="text-sm font-semibold text-[#CCCCCC]">Participants</h3>
      </div>
          ...
          {participants.map((participant) => (
            ...
            >
              <div className="relative">
                <div className="w-8 h-8 rounded-full bg-[#B0B0B0]/20 flex items-center justify-center">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-200 truncate">
                  ...
                  {participant.id === currentUserId && (
                    <span className="text-xs text-[#666666] ml-1">(you)</span>
                  )}
                </p>
              </div>
            </div>
